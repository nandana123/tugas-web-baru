 ...
 *
 * The followings are the available columns in table 'kereta':
 * @property integer $ID
 * @property string $Nama
 * @property integer $Kelas_id
 */
class Kereta extends CActiveRecord
{
	/**
	 ...
	 * @return Kereta the static model class
	 */
